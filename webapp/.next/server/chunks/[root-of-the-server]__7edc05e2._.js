...
"[project]/.next-internal/server/app/api/exercises/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/exercises/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: exercise, error } = await supabase.from('exercises').select('*').eq('id', resolvedParams.id).single();
...
async function DELETE(request, { params }) {
    try {
        ...
        const { error } = await supabase.from('exercises').delete().eq('id', resolvedParams.id);
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7edc05e2._.js.map