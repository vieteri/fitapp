...
"[project]/app/client-actions.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function isTokenExpired(token) {
    try {
        ...
        const decodedPayload = JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(payload, 'base64').toString());
...
function parseUserFromToken(token) {
    try {
        const [, payload] = token.split('.');
        const { sub, email, user_metadata } = JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(payload, 'base64').toString());
        return {
            id: sub,
            email,
            ...user_metadata
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const initializeAuth = {
                "AuthProvider.useEffect.initializeAuth": async ()=>{
                    try {
                        // Instant local check
                        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$client$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthToken"])();
                        ...
                        if (token && !isTokenExpired(token)) {
                            ...
                            const timeoutId = setTimeout({
                                "AuthProvider.useEffect.initializeAuth.timeoutId": ()=>controller.abort()
                            }["AuthProvider.useEffect.initializeAuth.timeoutId"], 3000); // 3s timeout
                            try {
                                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$client$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authFetch"])('/api/auth/verify', {
...
_s(AuthProvider, "SZ16lRhComQi8iK9JoUHDZbJ0oU=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
const createClient = ()=>{
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://shtjqplfdkcyljyoptmq.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNodGpxcGxmZGtjeWxqeW9wdG1xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTEyODMwNjIsImV4cCI6MjAyNjg1OTA2Mn0.dIE2Ys3_Nw7o71t0EEP8rte1ricmA_AX5w_gEb7DtLo"));
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
"[project]/components/ui/error-state.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$error$2d$state$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/error-state.tsx [app-client] (ecmascript)");
'use client';
;
;
;
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$error$2d$state$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
...
"[project]/components/ui/with-error-boundary.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/auth-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$with$2d$error$2d$boundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/with-error-boundary.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
...
_s(HeaderContent, "jjm4+8idXcN0/QhZj8SU7ISyS4g=", false, function() {
    return [
...
_c = HeaderContent;
const Header = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$with$2d$error$2d$boundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorBoundary"])(HeaderContent);
_c1 = Header;
var _c, _c1;
...
_s(ThemeSwitcherContent, "5ABGV54qnXKp6rHn7MS/8MjwRhQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
_c = ThemeSwitcherContent;
const ThemeSwitcher = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$with$2d$error$2d$boundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorBoundary"])(ThemeSwitcherContent);
_c1 = ThemeSwitcher;
var _c, _c1;
__turbopack_context__.k.register(_c, "ThemeSwitcherContent");
...
_c = FooterContent;
const Footer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$with$2d$error$2d$boundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorBoundary"])(FooterContent);
_c1 = Footer;
var _c, _c1;
...
//# sourceMappingURL=_a51b687f._.js.map